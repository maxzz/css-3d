...
function LogoPlay() {
    ...
    return (
        <svg viewBox="0 0 94.2 81.9" className="w-full h-full" strokeWidth="2">
            <filter filterUnits="objectBoundingBox" id="a">
                ...
                <feOffset dx="2" dy="-4" in="blur" result="offsetBlurredAlpha1" />
                <feOffset dx="3" dy="3" in="blur2" result="offsetBlurredAlpha2" />
                <feMerge>
            ...
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="15" y1="5.3" x2="70.3" y2="83.4">
                ...
                <stop offset="1" stopColor="rgba(185, 28, 28, .3)" />
            </linearGradient>
